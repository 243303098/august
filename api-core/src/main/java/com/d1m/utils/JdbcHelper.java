...
import com.d1m.excute.ExcuteAllCase;
...
public class JdbcHelper {
    ...
    public static Map query(String sql) throws SQLException {
     ...
     */
    @SuppressWarnings("rawtypes")
    public static Map query(String sql, Object... paramters)
            throws SQLException {
    ...
    public static Object insertWithReturnPrimeKey(String sql)
        ...
        Object result = null;
        try {
            conn = ExcuteAllCase.getConnection();
     ...
     */
    @SuppressWarnings("rawtypes")
    public static Map callableQuery(String procedureSql) throws SQLException {
        ResultSet rs = null;
        try {
     ...
     */
    @SuppressWarnings("rawtypes")
    public static Map callableQuery(String procedureSql, Object... paramters)
            throws SQLException {
        ResultSet rs = null;
        try {
            getCallableStatement(procedureSql);
    ...
    public static int[] batchUpdate(List<String> sqlList) {
        ...
        try {
            ...
            statenent = (Statement) conn.createStatement();
    ...
    private static Map ResultToMap(ResultSet rs) throws SQLException {
        Map map = null;
        while (rs.next()) {
    ...
    public static void free(ResultSet rs) {
        ...
        ExcuteAllCase.free(conn, preparedStatement, rs);
    }
    ...
    public static void free(Statement statement, ResultSet rs) {
        ExcuteAllCase.free(conn, statement, rs);
    }
